        ...
        <div className='eric-titles' data-aos="fade-up">
          <div className='eric-titles01' data-aos="fade-up">
            ...
            <div className="socials">
              <a href='https://twitter.com/ericzhu105'><img src={"/twitter.svg"} className="home-twitter" alt="twitter" /></a>
              <a href='https://www.linkedin.com/in/ericzhu105/'><img src={"/link.svg"} className="home-link" alt="link" /></a>
            </div>
          </div>
